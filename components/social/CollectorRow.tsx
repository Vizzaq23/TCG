...
export function CollectorRow({ collector, showFollow = true }: Props) {
  ...
  return (
    <li className="flex items-center gap-3 px-4 py-3.5 transition hover:bg-white/[0.02]">
      <Link
      ...
      >
        ...
        <div className="min-w-0">
          <p className="font-display truncate text-sm font-medium text-white">{title}</p>
