...
create table public.profiles (
  ...
  constraint profiles_username_lower_only check (username = lower(username))
);
...
create index cards_color_idx on public.cards (color);
...
create index collection_views_profile_id_idx on public.collection_views (profile_id);
create index collection_views_profile_viewed_at_idx on public.collection_views (profile_id, viewed_at desc);
...
-- Seed sample cards (replace image_url with your assets later)
