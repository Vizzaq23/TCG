-- BGS Black Label flag on graded collection entries

alter table public.user_collections
  add column if not exists is_black_label boolean not null default false;
  ...
  check (
    ...
    or (
      ...
      and (
        ...
        or (grading_company = 'BGS' and grade = 10)
      )
    )
  );
